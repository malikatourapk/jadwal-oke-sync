...
INSERT INTO public.receipt_items_new (receipt_id, product_id, product_name, quantity, unit_price, cost_price, total_price, profit, created_at)
SELECT r.invoice_number, ri.product_id, ri.product_name, ri.quantity, ri.unit_price, ri.cost_price, ri.total_price, ri.profit, ri.created_at
