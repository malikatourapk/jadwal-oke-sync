    ...
    <div className="min-h-screen w-full bg-background">
      ...
      <div className="w-full flex flex-col lg:flex-row">
        ...
        <Tabs value={currentTab} onValueChange={(value) => {
          ...
          <TabsList className="w-full flex flex-wrap gap-1 p-1 justify-stretch">
            <TabsTrigger value="pos" className="flex-1 min-w-[80px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Kasir
            </TabsTrigger>
            <TabsTrigger value="quick-invoice" className="flex-1 min-w-[80px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Nota Cepat
            </TabsTrigger>
            <TabsTrigger value="shopping-list" className="flex-1 min-w-[90px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Daftar Belanja
            </TabsTrigger>
            <TabsTrigger value="stock" className="flex-1 min-w-[60px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Stok
            </TabsTrigger>
            <TabsTrigger value="low-stock" className="flex-1 min-w-[90px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Stok Menipis
            </TabsTrigger>
            <TabsTrigger value="receipt" className="flex-1 min-w-[60px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Nota
            </TabsTrigger>
            <TabsTrigger value="reports" className="flex-1 min-w-[80px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Laporan
            </TabsTrigger>
            <TabsTrigger value="admin" className="flex-1 min-w-[70px] text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Admin
            </TabsTrigger>
          </TabsList>

          <TabsContent value="pos" className="space-y-2 sm:space-y-4 mt-2 sm:mt-4">
            {/* Mobile: Show cart below */}
        ...
        {/* Right Column: Cart - Desktop Only (Sticky) */}
        <div className="hidden lg:block w-[400px] xl:w-[450px] border-l bg-card/50">
          <div className="sticky top-[73px] p-4 max-h-[calc(100vh-73px)] overflow-y-auto">
            <Suspense fallback={<ComponentLoader />}>
              <LazyShoppingCart
                cart={cart}
                updateCartQuantity={updateCartQuantity}
